...
class FscBeneficiaryCertificateAdapter(
    ...
    @ConfigProperty(name = "fsc.api.urls.beneficiary", defaultValue = "https://apis.data.go.kr/1160100/service/GetStockSecuritiesInfoService/getSecuritiesPriceInfo") private val apiUrl: String
